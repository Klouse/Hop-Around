...
public StartScreenUIController uiController;
...
void controlSliding ()
{
	...
	{
		go.transform.GetChild(0).gameObject.GetComponent<Renderer>().material = blackMaterial;
	}
	else
	{
			go.transform.GetChild(0).gameObject.GetComponent<Renderer>().material = whiteMaterial;
	}
				// Show Boundary Cube.
